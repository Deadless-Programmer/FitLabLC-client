...
const Feedback = () => {
  ...
  const handleFeed = (event) => {
    ...
    console.log(_id);
    axiosSecure.patch(`/classCart/feedback/${_id}`, feedback).then((data) => {
      if (data) {
        form.reset();
        Swal.fire(
        ...
        navigate("/dashboard/manageclasseses");
      }
      ...
      <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-900  dark:text-gray-100">
        <div className="flex flex-col items-center w-full">
          ...
          <form onSubmit={handleFeed} className="flex flex-col w-full">
            ...
            <button
              type="submit"
              className="py-4 my-8 font-semibold rounded-md dark:text-gray-900 border text-white dark:bg-violet-400"
            >
              Leave feedback
            </button>
          </form>
