...
const Feedback = () => {
    ...
    const handleFeed=(event)=>{
		...
		const feedback = {feedback:feedbackValue};
    ...
    return (
        <div>
           <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-900  dark:text-gray-100">
	<div className="flex flex-col items-center w-full">
		<h2 className="text-3xl text-white font-semibold text-center">Your opinion matters!</h2>
		...
		<form  onSubmit={handleFeed} className="flex flex-col w-full">
			<textarea name="feedback" rows="3" placeholder="Message..." className="p-4 rounded-md resize-none dark:text-gray-100 dark:bg-gray-900"></textarea>
			<button type="submit" className="py-4 my-8 font-semibold rounded-md dark:text-gray-900 border text-white dark:bg-violet-400">Leave feedback</button>
		</form>
	</div>
