...
const Banner = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div  className="max-w-md">
      <h1 data-aos="fade-up" className="mb-5 text-5xl font-bold  ">Empowering Minds</h1>
      <p data-aos="zoom-in"  className="mb-5">At FitLab Learning Camp, we inspire young minds to embrace an active lifestyle, combining fitness education and outdoor adventures for a transformative summer camp experience that nurtures lifelong learning and healthy habits.</p>
      <button data-aos="flip-left"  className="btn bg-red-600 border-0 text-white hover:bg-lime-700 capitalize">join club now</button>
    </div>
  </div>
</div>
