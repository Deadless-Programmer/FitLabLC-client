  ...
  <div className="navbar-start lg:ml-16">
    ...
    <div className='lg:flex'>
                                <label className="swap swap-rotate">
                                    ...
                                    <img className="swap-on fill-current w-10 h-10" src="https://i.postimg.cc/fTZLsSMN/weather.png" alt="" />
                                    <img className="swap-off fill-current w-10 h-10" src="https://i.postimg.cc/nL6mGVBh/moon.png" alt="" />

                                    

                                </label>
            </div>
    <Link to="/" className=" font-bold text-2xl text-white ml-3 flex items-center "> FitLab<span className='text-red-600 font-extrabold '>LC</span> </Link>
  </div>
